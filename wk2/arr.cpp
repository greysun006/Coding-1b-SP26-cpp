...
int main() {
    ...
    scores[3] = 2456;
    scores[4] = -4;
    // scores[5] = 9999; // can't go past the size of the array
    ...
    while(index < 10) {
        ...
        // then add 1 to the index with the increment operator
        names[index++] = input;
    ...
    // with only the values wew specify
    // they only correspond to numbers, starting with 0 by default.
